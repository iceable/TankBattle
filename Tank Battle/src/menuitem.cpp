...
void hgeGUIMenuItem::Enter()
{
	...
	scolor2.SetHWColor(0x00f5fd16);
	tcolor2.SetHWColor(0xFFf5fd16);
...
void hgeGUIMenuItem::Leave()
{
	...
	scolor2.SetHWColor(0xFFf5fd16);
	tcolor2.SetHWColor(0x00f5fd16);
	dcolor2=tcolor2-scolor2;
